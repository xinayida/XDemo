...
import static com.example.wifi.WifiActivity.END;

/**
 * Created by ww on 2017/8/2.
 */

public class WifiActivity extends Activity implements DisplayMesage, ITransferResult {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtn3.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWifiAdmin.openWifi();
//                mWifiAdmin.addNetwork(mWifiAdmin.createWifiInfo(HOST_SPOT_SSID, HOST_SPOT_PASS_WORD,
//                        WifiAdmin.TYPE_WPA));
                mWifiAdmin.addNetwork(HOST_SPOT_SSID, HOST_SPOT_PASS_WORD,
                        WifiAdmin.TYPE_WPA);
        ...
        mBtn4.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wifiAp.startWifiAp(HOST_SPOT_SSID, HOST_SPOT_PASS_WORD);
            }
        });
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button1) {
            ...
            Log.w(TAG, "ip:" + ip + "serverAddress:" + serverAddress + info);
